...
- **Connection-unstable banner** (host-side): `CONNECTION_UNSTABLE` message from a guest flashes the same "Connection Unstable" indicator the guest shows for own stalls. Wire via `NetMatchConfig.onGuestConnectionUnstable`.
