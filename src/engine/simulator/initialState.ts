...
export function createInitialPlayers(
  ...
  return activePlayers.map((slot, index) => {
    ...
    breathTimer: 0, springTrailTimer: 0, springLaunchX: 0, springLaunchY: 0, fastFallStreakAlpha: 0, damageFlashSide: null, damageFlashTimer: 0, burnTimer: 0, hitstopTimer: 0,
