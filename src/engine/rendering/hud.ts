...
export function drawHUD(ctx: CanvasRenderingContext2D, state: MatchState, frameTime: number, playerNames: Record<string, string> | null): void {
  ...
  if (needsRedraw) {
    ...
    _drawHUDImpl(hctx as unknown as CanvasRenderingContext2D, state, frameTime, playerNames);
...
function _drawHUDImpl(ctx: CanvasRenderingContext2D, state: MatchState, frameTime: number, playerNames: Record<string, string> | null): void {
