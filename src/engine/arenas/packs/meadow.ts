...
function drawOneSnail(ctx: Ctx2D, time: number, snail: GroundCritterState, cfg: typeof SNAILS_CFG[number]): void {
  ctx.save();
...
function drawSnails(ctx: Ctx2D, time: number, players: ReadonlyArray<import('../../types').Player>): void {
