...
export const MEADOW_ARENA: Arena = {
  ...
  platforms: [
    ...
    // Tree stump — on mid-left platform
    { x: 440, y: 370, width: 45, height: 40 },
    // Tree stump — on mid-right platform
...
export const WINTER_LAKE_ARENA: Arena = {
  ...
  platforms: [
    ...
    // Ice cube — left ground (solid block)
    { x: 380, y: 610, width: 65, height: 50 },
    // Ice cube — right ground
    { x: 835, y: 610, width: 65, height: 50 },
    // Ice cube — floating mid-left
    { x: 370, y: 370, width: 60, height: 50 },
  ],
  spawnPoints: [
    { x: 180, y: 520 },
    { x: 1100, y: 520 },
