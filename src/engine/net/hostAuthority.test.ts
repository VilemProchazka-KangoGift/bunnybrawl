...
const mockGameLoopInstance = {
  ...
  renderFrame: vi.fn(),
  skipCountdown: vi.fn(),
  // Phase 2 NetMatchDriver hooks. Default to local-sim behavior (isRemoteSim
  // returns false) so the existing test scenarios continue to exercise the
  // local-state-mutation branch.
